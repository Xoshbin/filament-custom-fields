...
class EditCustomFieldDefinition extends EditRecord
{
    ...
    {
        return __('custom-fields::custom_fields.actions.edit');
    }
    ...
    protected function getHeaderActions(): array
    {
        return [
            Actions\DeleteAction::make()
                ->label(__('custom-fields::custom_fields.actions.delete'))
                ->requiresConfirmation()
                ->modalHeading(__('custom-fields::custom_fields.actions.delete_modal_heading'))
                ->modalDescription(__('custom-fields::custom_fields.actions.delete_modal_description'))
                ->modalSubmitActionLabel(__('custom-fields::custom_fields.actions.delete')),
        ];
    }

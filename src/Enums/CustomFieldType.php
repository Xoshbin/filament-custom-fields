...
namespace Xoshbin\CustomFields\Enums;
...
enum CustomFieldType: string implements HasColor, HasIcon, HasLabel
{
    ...
    {
        return match ($this) {
            self::Text => __('custom-fields::enums.custom_field_type.text'),
            self::Textarea => __('custom-fields::enums.custom_field_type.textarea'),
            self::Number => __('custom-fields::enums.custom_field_type.number'),
            self::Boolean => __('custom-fields::enums.custom_field_type.boolean'),
            self::Date => __('custom-fields::enums.custom_field_type.date'),
            self::Select => __('custom-fields::enums.custom_field_type.select'),
        };
    }
